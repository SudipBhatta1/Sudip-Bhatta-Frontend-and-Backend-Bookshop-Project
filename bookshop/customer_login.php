...
if ($_POST) {
    ...
    // Only check credentials if both fields are filled and valid
    if (empty($errors)) {
        try {
            ...
            error_log("Database error during customer login: " . $e->getMessage());
...
<head>
    ...
    <title>Customer Login - Bookshop</title>
    ...
    <div class="container">
        <div class="login-box">
            ...
            <form method="POST" novalidate>
                ...
                <button type="submit" class="btn btn-customer">Login</button>
            </form>
